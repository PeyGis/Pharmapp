...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            if (googleMap != null){
                ...
                mMap.addMarker(new MarkerOptions().position(ashesi).title("Pharmacy at Ashesi"));
                mMap.addMarker(new MarkerOptions().position(kwabenya).title("Pharmacy at Madina"));
                mMap.addMarker(new MarkerOptions().position(kumasi).title("Pharmacy at Kumasi"));
    ...
    public void openDialog(){
        ...
        final String[] options = {"Buy Drug", "Call Pharmacist", "Report"};
